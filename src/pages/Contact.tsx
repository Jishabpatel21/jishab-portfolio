...
const socialLinks = [
  { href: "https://github.com/Jishabpatel21", icon: Github, label: "GitHub", handle: "@Jishabpatel21" },
  { href: "https://linkedin.com/in/jishab-patel", icon: Linkedin, label: "LinkedIn", handle: "/in/jishab-patel" },
  { href: "mailto:jishabpatel13@gmail.com", icon: Mail, label: "Email", handle: "jishabpatel13@gmail.com" },
];
